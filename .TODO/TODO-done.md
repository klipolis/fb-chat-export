...
- T-202. Added Unicode sender + image pipeline tests: `buildEntryFromEntry` with Ötves Erno image and `extractMessageEntry` DOM pipeline with Álvaro/?? image entries.
